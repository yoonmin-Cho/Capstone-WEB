		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a class="page-scroll" href="/ZEBRA/product?category=0&subCategory=0">Product</a></li>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a class="page-scroll" href="/ZEBRA/aboutService">About Services</a></li>
					<li><a class="page-scroll" href="/ZEBRA/powerReviewer">Power Reviewer</a></li>
					<li><a class="page-scroll" href="/ZEBRA/product?category=0&subCategory=0">Product & Purchase</a></li>
				</ul>
